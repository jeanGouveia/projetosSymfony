 ...
 */
final class Version20220311192038 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medico DROP especialidade_id, CHANGE nome nome VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
